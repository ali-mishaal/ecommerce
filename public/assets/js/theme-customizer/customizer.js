...
$('<div class="customizer-links"> ' +
    ...
    '<div class="settings"> <i class="icon-settings"></i> </div></a> </div></div><div class="customizer-contain"> ' +
    '<div class="tab-content" id="c-pills-tabContent"> <div class="customizer-header"> ' +
    '<i class="icofont-close icon-close"></i> ' +
    '<h5>Customizer</h5> ' +
    '<p class="mb-0">Customize &amp; Preview Real Time</p></div>' +
...
$(document).ready(function() {
    ...
    // function moved to js.blade to use php
