...
use App\DataTables\OrderDoneDatatable;
use Carbon\Carbon;
...
{
    public function index(OrderDoneDatatable $orderDoneDatatable)
    {
        ...
        return $orderDoneDatatable
            ...
            ->render('reportmodule::orderDone.index', compact('drivers', 'supervisors', 'statuses', 'order_statuses'));
    }
