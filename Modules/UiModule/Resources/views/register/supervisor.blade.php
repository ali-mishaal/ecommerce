                    ...
                    <div class="col-md-8 col-lg-8">
                        <div class="card login-signup-card shadow-lg mb-0">
                            <div class="card-body px-md-5 py-5">
                                <div class="mb-5">
                                    <h5 class="h3">{{ trans('lang.create_supervisor') }}</h5>
                                    <p class="text-muted mb-0">{{ trans('lang.create_new_customer') }}</p>
                                </div>

                                <!--login form-->

                                <form id="register" action="{{route('supervisor.register')}}" class="needs-validation login-signup-form" novalidate="">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control" id="civil_id" name="civil_id" type="number" maxlength="12" minlength="12"
                                                   placeholder="{{ trans('lang.placeholder', ['attribute' => trans('lang.civil_id')]) }}" required="" data-original-title=""
                                                   title="">
                                    ...
                                    <!-- Submit -->
                                    <button type="submit" id="submit" class="btn btn-lg btn-block solid-btn border-radius mt-4 mb-3">
                                        {{ trans('lang.sign_up') }}
                                    </button>
