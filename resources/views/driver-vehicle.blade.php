...
<div class="btn-create">
    <button class="btn btn-primary mb-2 mr-1" data-toggle="modal" data-target="#create-vehicle"> <i
            class="icon-plus pr-1"></i> Create vehicle</button>
    <button class="btn btn-outline-primary mb-2" data-toggle="modal" data-target="#create-type"> <i
            class="icon-plus pr-1"></i> Create type vehicle</button>
</div>
<div class="vehicle-page all-pages">
    <div class="card-header">

        <h5>Driver for vehicle</h5><span>lorem ipsum dolor sit amet, consectetur adipisicing elit</span>
    </div>
    <div class="card-body">
...
<!-- Modal create type vehicle -->

<div class="modal fade bd-example-modal-lg create-type" id="create-type" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Create type vehicle</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="needs-validation" novalidate="">
                    <div class="">
                        <div class="mb-3">
                            <label for="validationCustom01">Name type (AR)</label>
                            <input class="form-control" id="validationCustom01" type="text"
                                placeholder="Enter name by arabic" required="">
                            <div class="valid-feedback">Looks good!</div>
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01">Name type (EN)</label>
                            <input class="form-control" id="validationCustom01" type="text"
                                placeholder="Enter name by english" required="">
                            <div class="valid-feedback">Looks good!</div>
                        </div>
                </form>
            </div>
